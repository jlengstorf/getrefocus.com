...
var paths = {
  ...
  templates: {
    src: ['templates/**/*.jade', '!templates/layouts/**/*.jade', '!templates/includes/**/*.jade'],
    destDir: 'layouts',
...
gulp.task('watch', function(  ) {
  ...
  gulp.watch([paths.templates.watch, 'static/css/main.min.css'], ['templates']);
...
gulp.task('templates', () => {
  gulp.src(paths.templates.src, { cwd: 'source'})
      .pipe(jade({
